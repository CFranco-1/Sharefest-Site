"""
Django settings for sharefestsite project.
...
SECRET_KEY = 'duz#&fhydsfc&ru*&o1m@ctmo)ci93co83&2&7dya#s85b79h^'
...
ROOT_URLCONF = 'sharefestsite.urls'
...
WSGI_APPLICATION = 'sharefestsite.wsgi.application'
